...
public class MailUtil {
    ...
    private static final String content = MailConfig.content;
     ...
     */
    public static void sendMail(String to, String content) throws MessagingException,UnsupportedEncodingException {
